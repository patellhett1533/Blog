...
const ImageShow = (props) => {
  ...
  const saveData = (file) => {
    props.setContent([...props.content, { type: "image", data: file }]);
  };
  ...
  return (
    <div className="flex items-center justify-center mb-2">
      ...
      <div
        className="empty-img w-full h-64 rounded-lg cursor-pointer flex flex-col items-center justify-center border border-border"
        onClick={openMedia}
      >
        <svg
          width="36"
