...
const Footer = () => {
  ...
  return (
    <div className="px-10 py-6 flex  items-center justify-between bg-background">
      <div className="copyright-info">
        <p className="text-primary">
          Copyright &copy;&nbsp;
          <span className="underline font-heading underline-offset-4">
            Groupon
          </span>{" "}
          2023
        </p>
      </div>
      <div className="darkmod cursor-pointer">
        {theme === "dark" ? (
          <svg
            width="24"
            height="24"
          ...
          >
            <rect width="24" height="24" className="fill-background" />
            <path
              fillRule="evenodd"
              clip-rule="evenodd"
